...
function HeroSection() {
  return (
    ...
    justify-center relative overflow-hidden mx-auto py-10 md:py-0 bg-dot-white/[0.2]">
      <Spotlight
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg
            mx-auto">
          Dive into our comprehensive music courses and transform your musical journey
          today. Whether you&apos;re a beginner or looking to refine your skills, join us
        ...
        <div className="mt-4">
          <Link href="/courses">
            <Button
              ...
              className="bg-white dark:bg-black text-black dark:text-slate-400 
              border-neutral-200 dark:border-slate-800 font-semibold"
            >
              Explore Courses
            </Button>
          </Link>
